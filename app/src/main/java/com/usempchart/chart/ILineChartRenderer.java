 ...
 **/
public class ILineChartRenderer extends LineRadarRenderer {
    ...
    public ILineChartRenderer(LineDataProvider chart, ChartAnimator animator,
     ...
     */
    private HashMap<IDataSet, ILineChartRenderer.DataSetImageCache> mImageCaches = new HashMap<>();
    ...
    protected void drawCircles(Canvas c) {
        ...
        for (int i = 0; i < dataSets.size(); i++) {
            ...
            ILineChartRenderer.DataSetImageCache imageCache;

            if (mImageCaches.containsKey(dataSet)) {
                imageCache = mImageCaches.get(dataSet);
            } else {
                imageCache = new ILineChartRenderer.DataSetImageCache();
