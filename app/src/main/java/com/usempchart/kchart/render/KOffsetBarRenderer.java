 ...
 */
public class KOffsetBarRenderer extends BarChartRenderer {
    ...
    public KOffsetBarRenderer(BarDataProvider chart, ChartAnimator animator, ViewPortHandler viewPortHandler) {
        this(chart, animator, viewPortHandler, 0);
    }

    public KOffsetBarRenderer(BarDataProvider chart, ChartAnimator animator,
    ...
    public void initBuffers() {
        ...
        mBarBuffers = new KOffsetBarBuffer[barData.getDataSetCount()];

        for (int i = 0; i < mBarBuffers.length; i++) {
            IBarDataSet set = barData.getDataSetByIndex(i);
            mBarBuffers[i] = new KOffsetBarBuffer(set.getEntryCount() * 4 *
    ...
    public KOffsetBarRenderer setHighlightWidthSize(float width, float textSize) {
