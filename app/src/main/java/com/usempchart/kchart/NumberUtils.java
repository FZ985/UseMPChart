...
//        String str;
//        if (vol >= 100000000) {
//            str = df.format(vol / 100000000) + (assetId.endsWith(".HK") ? context.getResources().getString(com.github.mikephil.charting.R.string.billions_gu) : context.getResources().getString(com.github.mikephil.charting.R.string.billions_shou));
//        } else if (vol >= 10000) {
//            str = df.format(vol / 10000) + (assetId.endsWith(".HK") ? context.getResources().getString(com.github.mikephil.charting.R.string.millions_gu) : context.getResources().getString(com.github.mikephil.charting.R.string.millions_shou));
//        } else {
//            str = df.format(Math.round(vol)) + (assetId.endsWith(".HK") ? context.getResources().getString(com.github.mikephil.charting.R.string.gu) : context.getResources().getString(com.github.mikephil.charting.R.string.shou));
//        }
//        return str;
//    }
