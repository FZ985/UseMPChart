 ...
 * 图表长按及滑动手指监听
 */
public class KChartFingerTouchListener implements View.OnTouchListener {
    ...
    public KChartFingerTouchListener(BarLineChartBase chart, HighlightListener listener) {
        mChart = chart;
        mListener = listener;
