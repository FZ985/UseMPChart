package com.usempchart.kchart.listener;
 ...
 * 图表联动高亮监听
 */
public class KCoupleChartValueSelectedListener implements OnChartValueSelectedListener {

    private BarLineChartBase srcChart;
    private BarLineChartBase[] dstCharts;
    private ValueSelectedListener mListener;

    public KCoupleChartValueSelectedListener(BarLineChartBase srcChart, BarLineChartBase... dstCharts) {
        this(null, srcChart, dstCharts);
    }

    public KCoupleChartValueSelectedListener(ValueSelectedListener mListener,
    ...
    public interface ValueSelectedListener {
        void valueSelected(Entry e,Highlight h);
